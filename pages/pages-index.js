...
function AIBox({ block, payload }) {
  ...
  return (
    <div style={styles.aiBox}>
      <div className="s-pages-pages-index-js-auto1" style={{{rest}}}>
        <div className="s-pages-pages-index-js-auto2">{block==="procurement" ? "현황분석" : "🤖 AI 분석"}</div>
        <button onClick={() => setOpen(o=>!o)} className="s-pages-pages-index-js-btngray">{open ? "접기" : "분석보기"}</button>
      </div>
      {open && (
        <>
          {loading && <div className="s-pages-pages-index-js-auto3">분석 중…</div>}
          {err && <div className="s-pages-pages-index-js-auto4">오류: {err}</div>}
          {!loading && !err && <div className="s-pages-pages-index-js-auto5">{redactForbidden(text) || "분석 결과가 없습니다."}</div>}
        </>
      )}
    </div>
  );
  ...
  return (
    <header style={styles.headerWrap}>
      <div style={styles.headerInner}>
        <div className="s-pages-pages-index-js-brand">
          <span>Hansoll Market Trend</span>
        </div>
        <nav style={styles.nav}>
          <a href="/" className="s-pages-pages-index-js-navlink">Dashboard</a>
          <a href="/daily-report" className="s-pages-pages-index-js-navlink">AI Daily Report</a>
        </nav>
      </div>
    </header>
  );
...
function ProcurementTopBlock() {
  ...
  const Card = ({ title, value, sub }) => (
    <div className="s-pages-pages-index-js-card">
      <div className="s-pages-pages-index-js-cardtitle">{title}</div>
      <div className="s-pages-pages-index-js-cardvalue">{value}</div>
      {sub ? <div className="s-pages-pages-index-js-cardsub">{sub}</div> : null}
    </div>
  );

  return (
    <section className="s-pages-pages-index-js-blockwrap">
      <div className="s-pages-pages-index-js-headerrow">
        <div>
          <h2 className="s-pages-pages-index-js-h2">부자재구매현황 DASHBOARD (sample data입니다)</h2>
          <div className="s-pages-pages-index-js-meta">
      ...
      <div >
      <div className="s-pages-pages-index-js-grid5">
        ...
        <div className="s-pages-pages-index-js-card">
          <div className="s-pages-pages-index-js-cardtitle">매출 대비 부자재 매입비중</div>
          <div className="s-pages-pages-index-js-cardvalue">{fmtSignPct(ratio, 1)}</div>
      ...
      <div style={styles.innerBlock}>
        <div className="s-pages-pages-index-js-blocktitle">공급현황 (국내 / 3국 / 현지)</div>
        ...
        <div className="s-pages-pages-index-js-legend">
      ...
      {false && (
        <div style={styles.editBox}>
          <div className="s-pages-pages-index-js-row">
            <label>기간 표시</label>
          ...
          <div style={styles.grid2}>
            <div className="s-pages-pages-index-js-row"><label>총 매출액</label><input type="number" value={data.revenue} onChange={(e) => setData(d => ({ ...d, revenue: Number(e.target.value) }))} /></div>
            <div className="s-pages-pages-index-js-row"><label>총 부자재매입액</label><input type="number" value={data.materialSpend} onChange={(e) => setData(d => ({ ...d, materialSpend: Number(e.target.value) }))} /></div>
          </div>
          <div style={styles.grid2}>
            <div className="s-pages-pages-index-js-row"><label>총 오더수(스타일)</label><input type="number" value={data.styles} onChange={(e) => setData(d => ({ ...d, styles: Number(e.target.value) }))} /></div>
            <div className="s-pages-pages-index-js-row"><label>총 발행 PO수</label><input type="number" value={data.poCount} onChange={(e) => setData(d => ({ ...d, poCount: Number(e.target.value) }))} /></div>
          </div>
          <div className="s-pages-pages-index-js-auto6" style={{{rest}}}>
            <div className="s-pages-pages-index-js-blocktitle">공급현황(%) — 합계 100 기준</div>
            <div className="s-pages-pages-index-js-grid3">
              <div className="s-pages-pages-index-js-row"><label>국내(%)</label><input type="number" value={data.supplyBreakdown.domestic}
                onChange={(e) => setData(d => ({ ...d, supplyBreakdown: { ...d.supplyBreakdown, domestic: Number(e.target.value) } }))} /></div>
              <div className="s-pages-pages-index-js-row"><label>3국(%)</label><input type="number" value={data.supplyBreakdown.thirdCountry}
                onChange={(e) => setData(d => ({ ...d, supplyBreakdown: { ...d.supplyBreakdown, thirdCountry: Number(e.target.value) } }))} /></div>
              <div className="s-pages-pages-index-js-row"><label>현지(%)</label><input type="number" value={data.supplyBreakdown.local}
                onChange={(e) => setData(d => ({ ...d, supplyBreakdown: { ...d.supplyBreakdown, local: Number(e.target.value) } }))} /></div>
            </div>
          </div>
          <div className="s-pages-pages-index-js-auto7">
            <button onClick={save} className="s-pages-pages-index-js-btnblue">저장</button>
            <button  className="s-pages-pages-index-js-btngray">닫기</button>
            <button onClick={reset} className="s-pages-pages-index-js-btndanger">초기화</button>
          </div>
        </div>
      )}
    </section>
...
function Sparkline({ series = [], width = 110, height = 32 }) {
  ...
  return (
    <svg width={width} height={height} className="s-pages-pages-index-js-auto8">
...
function IndicatorsSection() {
  ...
  return (
    <section className="s-pages-pages-index-js-auto9">
      <h3 className="s-pages-pages-index-js-h3">주요 지표</h3>
      {lastUpdated && (
        <div className="s-pages-pages-index-js-auto10" style={{{rest}}}>
      ...
      {!state.loading && !state.error && (
        <>
          <div className="s-pages-pages-index-js-grid4">
            {curated.map((c) => {
              ...
              return (
                <a key={c.key} href={href} target="_blank" rel="noreferrer" style={{ ...styles.card, ...styles.cardLink }} title="원본 데이터 열기">
                  <div className="s-pages-pages-index-js-cardtitle">{c.title}</div>
                  <div className="s-pages-pages-index-js-cardvalue">{v != null ? fmtNum(v) : "-"}</div>
...
function StocksSection() {
  ...
  function renderSection(sec, idx) {
    ...
    const flushList = () => { if (list.length) { items.push(<ul key={"ul"+items.length} className="s-pages-pages-index-js-auto11">{list.map((t,i)=><li key={i} className="s-pages-pages-index-js-auto12">{t}</li>)}</ul>); list = []; } };
    for (const raw of sec.lines) {
      const ln = raw.trim();
      if (!ln) { flushList(); continue; }
      if (/^[-•]\s+/.test(ln)) { inList = true; list.push(ln.replace(/^[-•]\s+/, "")); continue; }
      if (inList) { flushList(); inList = false; }
      items.push(<p key={"p"+items.length} className="s-pages-pages-index-js-auto13">{ln}</p>);
    }
    flushList();
    const titleMap = {
  ...
  function renderSummaryBox(sym) {
    ...
    return (
      <div style={{
        ...
        <div className="s-pages-pages-index-js-auto14" style={{{rest}}}>
...
useEffect(() => {
  ...
  return (
    <section className="s-pages-pages-index-js-auto15">
      <h3 className="s-pages-pages-index-js-h3">일일 리테일러 주가 등락률 (전일 종가 대비)</h3>
            ...
            {sorted.map((r) => {
              ...
              return (
                ...
                <div key={r.symbol} style={{ ...styles.card }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
                    <div>
                      <div style={{ ...styles.cardTitle }}>
                        {r.name} <span className="s-pages-pages-index-js-auto16">({r.symbol})</span>
                      </div>
                    ...
                    <div className="s-pages-pages-index-js-auto17">
                  ...
                  {sumState[r.symbol]?.open && (<div className="s-pages-pages-index-js-auto18">{renderSummaryBox(r.symbol)}</div>)}
                </div>
...
function NewsTabsSection() {
  ...
  return (
    <section className="s-pages-pages-index-js-auto19">
      <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", gap:12, flexWrap:"wrap" }}>
        <div className="s-pages-pages-index-js-auto20">
      ...
      <div style={{ marginTop: 12, border:"1px solid #e5e7eb", borderRadius:12, background:"#fff" }}>
        ...
        {!newsLoading && !newsErr && (
          <div className="s-pages-pages-index-js-auto21">
            {rendered.length === 0 ? (
              <div className="s-pages-pages-index-js-auto22">관련 기사가 아직 없어요.</div>
            ) : (
              <ol className="s-pages-pages-index-js-auto23">
                {rendered.map((it, i) => (
                  <li key={i} className="s-pages-pages-index-js-auto24">
                    <a href={it.url} target="_blank" rel="noreferrer" className="s-pages-pages-index-js-auto25">{it.title}</a>
            ...
            {newsItems.length > 5 && (
              <div className="s-pages-pages-index-js-auto26">
...
function NewsAISummaryPanel({ title, endpoint }) {
  ...
  return (
    <div style={{ border:"1px solid #e5e7eb", borderRadius:12, padding:14, background:"#fff" }}>
      <div className="s-pages-pages-index-js-auto27" style={{{rest}}}>
        <h3 className="s-pages-pages-index-js-auto28">{title}</h3>
        <div className="s-pages-pages-index-js-auto29">
          <button onClick={load} disabled={loading} style={{ ...styles.btnTab }}>{loading ? "요약 중..." : "다시 요약"}</button>
        </div>
      </div>

      {err && <div className="s-pages-pages-index-js-auto30">에러: {err}</div>}
      {!data && !loading && <div>요약을 불러오는 중…</div>}
      {data && (
        <div className="s-pages-pages-index-js-auto31" style={{{rest}}}>
          <div className="s-pages-pages-index-js-auto32" style={{{rest}}}>
            {sections.map((sec, idx) => (
              <section key={idx} style={{ marginTop: idx===0?0:12 }}>
                {sec.title ? <h4 className="s-pages-pages-index-js-auto33">{sec.title === "Implications for Hansoll" ? "한솔섬유 전략에 미치는 시사점" : sec.title}</h4> : null}
                <div
                  className="s-pages-pages-index-js-auto34"
                  dangerouslySetInnerHTML={{ __html: LinkifyCitations(sec.body).replace(/^-\s+/gm, "• ").replace(/\n/g, "<br/>") }}
                />
              </section>
            ))}
          </div>
          <aside className="s-pages-pages-index-js-auto35">
            <h4 className="s-pages-pages-index-js-auto36">참조 뉴스</h4>
            <ol className="s-pages-pages-index-js-auto37">
              {(data.items || []).slice(0, 20).map((it, i) => (
                <li id={`ref-${i+1}`} key={i} className="s-pages-pages-index-js-auto38">
                  <a href={it.link} target="_blank" rel="noreferrer" className="s-pages-pages-index-js-auto39">{it.title}</a>
...
function NewsAISummarySection() {
  return (
    <div className="s-pages-pages-index-js-auto40">
      <div style={{ ...styles.blockTitle }}>뉴스 AI 분석</div>
      <div className="s-pages-pages-index-js-auto41" style={{{rest}}}>
...
export default function Home() {
  ...
  return (
    <>
      ...
      <main className="s-pages-pages-index-js-auto42" style={{{rest}}}>
        <ProcurementTopBlock />
        <IndicatorsSection />
        <StocksSection />
        <NewsTabsSection />
      ...
      <footer style={styles.footer}>
        <div className="s-pages-pages-index-js-auto43" style={{{rest}}}>
