/**
 * 참고: 현재 페이지 레이아웃은 유지하고, 섹션 타이틀만 아래처럼 맞추세요.
 * Dashboard 섹션 타이틀: "부자재구매현황 DASHBOARD (SAMPLE DATA)"
 * 나머지 섹션 타이틀은 기존 그대로 사용해도 됩니다.
 *
 * 실제 프로젝트의 pages/index.js에 이 부분만 적용하세요.
 */
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto p-4 space-y-8">
        <section className="bg-white shadow rounded-xl p-6">
          <h2 className="text-2xl font-bold text-blue-900 mb-4">부자재구매현황 DASHBOARD (SAMPLE DATA)</h2>
