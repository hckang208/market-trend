...
export default function ProcurementTopBlock() {
  ...
  return (
    <section style={{ position:"sticky", top: 12, zIndex: 50, border: "1px solid #e5e7eb", borderRadius: 12, padding: 16, background: "#fff" }}>
      <header className="s-components-procurementtopblock-jsx-auto1" style={{{rest}}}>
        <h3 className="s-components-procurementtopblock-jsx-auto2">부자재 구매 현황 (sample data입니다)</h3>
        <div className="s-components-procurementtopblock-jsx-auto3">
          ...
          <label style={btn("ghost", true)}>
            Import
            <input type="file" accept="application/json" onChange={e => e.target.files[0] && importJson(e.target.files[0])} className="s-components-procurementtopblock-jsx-auto4" />
          </label>
        </div>
      </header>

      <p className="s-components-procurementtopblock-jsx-auto5">{data.periodLabel} · 통화 {data.currency}</p>

      <div className="s-components-procurementtopblock-jsx-auto6" style={{{rest}}}>
      ...
      <div className="s-components-procurementtopblock-jsx-auto7" style={{{rest}}}>
      ...
      {summary && (
        <div className="s-components-procurementtopblock-jsx-auto8" style={{{rest}}}>
          {summary}
        </div>
      )}
...
function Stat({ label, value, unit }) {
  return (
    <div className="s-components-procurementtopblock-jsx-auto9">
      <div className="s-components-procurementtopblock-jsx-auto10">{label}</div>
      <div className="s-components-procurementtopblock-jsx-auto11">
        {value}{unit ? ` ${unit}` : ""}
      </div>
    </div>
  );
...
function EditDialog({ data, setData, onClose, onSave }) {
  ...
  return (
    <div style={modal()}>
      <div style={sheet()}>
        <h4 className="s-components-procurementtopblock-jsx-auto12">부자재 현황 편집</h4>
        ...
        <details className="s-components-procurementtopblock-jsx-auto13">
          <summary className="s-components-procurementtopblock-jsx-auto14">선택 입력: 작년 기준값</summary>
          <div className="s-components-procurementtopblock-jsx-auto15">
            <div style={grid(4)}>
        ...
        <div className="s-components-procurementtopblock-jsx-auto16" style={{{rest}}}>
